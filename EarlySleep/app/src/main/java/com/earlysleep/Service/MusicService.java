...
public class MusicService extends Service {
    ...
    //服务要发送的一些Action
    public static final String UPDATE_ACTION = "com.earlysleep.action.UPDATE_ACTION";  //更新动作
    public static final String CTL_ACTION = "com.earlysleep.action.CTL_ACTION";        //控制动作
    public static final String MUSIC_CURRENT = "com.earlysleep.action.MUSIC_CURRENT";  //当前音乐播放时间更新动作
    public static final String MUSIC_DURATION = "com.earlysleep.action.MUSIC_DURATION";//新音乐长度更新动作
    ...
    public void onCreate() {
        ...
        mp3Infos =  DataSupport.findAll(Music.class);
    ...
    public void onStart(Intent intent, int startId) {
        ...
        System.out.println("进入onStart"+path+":"+current);
